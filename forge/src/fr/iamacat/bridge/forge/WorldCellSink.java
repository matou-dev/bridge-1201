...
/**
 * D1 live sink: pure decision cells to 1.20.1 world edits. Plane
...
public final class WorldCellSink implements CellSink {
    /** 1.20.1 overworld height: y lives in 0..255. */
    ...
    /** Single owner of the 1.20.1 height rule (also used at wire bind). */
