...
public final class SpawnCheck {
    ...
    public static void main(String[] args) {
        ...
        // The forge dispatch stays single-mob (ports tranche TODO): the
        // legacy sole view refuses on the 2-mob content instead of
        // picking a spawnee silently — documents why the dispatch port
        // is needed, never silent.
        final SpawnTable multi = wired;
        expectIAE(new Runnable() {
            @Override public void run() { multi.mob(); }
        }, "sole-view mob on multi");
