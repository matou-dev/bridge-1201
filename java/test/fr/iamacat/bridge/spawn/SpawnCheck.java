...
public final class SpawnCheck {
    ...
    public static void main(String[] args) {
        ...
        // Sole views still refuse on multi (never a quiet pick): the
        // per-mob getters above serve both mobs, the legacy view stays
        // single-mob-only by contract (hub decisions/VIRTUAL_HITBOXES.md
        // second-beast row).
